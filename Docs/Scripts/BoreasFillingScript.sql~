DECLARE
   ...
   b number;
   c number;
   e_date date:= Sysdate - 10;
   pr_date date:= Sysdate - 8;
   c_date date:= Sysdate - 6;
BEGIN
  INSERT INTO roles
  (name )
  VALUES
 ...
 ('gold internet');
  ...
  for a in 1..17 loop
   ...
   FOR a in 1 .. 70 LOOP
		...
		values
		(e_date + 1/24 * a, pr_date + 1/24 * a, c_date + 1/24 * a, a, 1, 1, a, 'completed', 'New', null);
  ...
  FOR a in 71 .. 140 LOOP
		...
		(enterdate, procesdate, completedate, user_id, service_id, provider_location_id, service_location_id, status, scenario, service_instance_id)
		values
		(e_date + 1/24 * a, pr_date + 1/24 * a, c_date + 1/24 * a, a, 2, 1, a, 'completed', 'New', null);
		insert into service_instances
		(user_id, service_order_id, status, service_id)
		values
		(a, a, 'active', 2);
  ...
  END LOOP;
   FOR a in 141 .. 200 LOOP
		...
		(enterdate, procesdate, completedate, user_id, service_id, provider_location_id, service_location_id, status, scenario, service_instance_id)
		values
		(e_date + 1/24 * a, pr_date + 1/24 * a, c_date + 1/24 * a, a, 3, 1, a, 'completed', 'New', null);
		insert into service_instances
		(user_id, service_order_id, status, service_id)
		values
		(a, a, 'active', 3);
  ...
  FOR a in 201 .. 270 LOOP
		...
		(enterdate, procesdate, completedate, user_id, service_id, provider_location_id, service_location_id, status, scenario, service_instance_id)
		values
		(e_date + 1/24 * a, pr_date + 1/24 * a, c_date + 1/24 * a, a, 3, 2, a, 'completed', 'New', null);
		insert into service_instances
		(user_id, service_order_id, status, service_id)
		values
		(a, a, 'active', 3);
  ...
  FOR a in 271 .. 340 LOOP
		...
		(enterdate, procesdate, completedate, user_id, service_id, provider_location_id, service_location_id, status, scenario, service_instance_id)
		values
		(e_date + 1/24 * a, pr_date + 1/24 * a, c_date + 1/24 * a, a, 4, 2, a, 'completed', 'New', null);
		insert into service_instances
		(user_id, service_order_id, status, service_id)
		values
		(a, a, 'active', 4);
  ...
  FOR a in 341 .. 400 LOOP
		...
		(enterdate, procesdate, completedate, user_id, service_id, provider_location_id, service_location_id, status, scenario, service_instance_id)
		values
		(e_date + 1/24 * a, pr_date + 1/24 * a, c_date + 1/24 * a, a, 5, 2, a, 'completed', 'New', null);
		insert into service_instances
		(user_id, service_order_id, status, service_id)
		values
		(a, a, 'active', 5);
  ...
  FOR a in 401 .. 470 LOOP
		...
		(enterdate, procesdate, completedate, user_id, service_id, provider_location_id, service_location_id, status, scenario, service_instance_id)
		values
		(e_date + 1/24 * a, pr_date + 1/24 * a, c_date + 1/24 * a, a, 1, 3, a, 'completed', 'New', null);
		insert into service_instances
		(user_id, service_order_id, status, service_id)
		values
		(a, a, 'active', 1);
  ...
  FOR a in 471 .. 540 LOOP
		...
		(enterdate, procesdate, completedate, user_id, service_id, provider_location_id, service_location_id, status, scenario, service_instance_id)
		values
		(e_date + 1/24 * a, pr_date + 1/24 * a, c_date + 1/24 * a, a, 2, 3, a, 'completed', 'New', null);
		insert into service_instances
		(user_id, service_order_id, status, service_id)
		values
		(a, a, 'active', 2);
  ...
  FOR a in 541 .. 600 LOOP
		...
		(enterdate, procesdate, completedate, user_id, service_id, provider_location_id, service_location_id, status, scenario, service_instance_id)
		values
		(e_date + 1/24 * a, pr_date + 1/24 * a, c_date + 1/24 * a, a, 3, 3, a, 'completed', 'New', null);
		insert into service_instances
		(user_id, service_order_id, status, service_id)
		values
		(a, a, 'active', 3);
  ...
  FOR a in 601 .. 670 LOOP
		...
		(enterdate, procesdate, completedate, user_id, service_id, provider_location_id, service_location_id, status, scenario, service_instance_id)
		values
		(e_date + 1/24 * a, pr_date + 1/24 * a, c_date + 1/24 * a, a, 3, 4, a, 'completed', 'New', null);
		insert into service_instances
		(user_id, service_order_id, status, service_id)
		values
		(a, a, 'active', 3);
  ...
  FOR a in 671 .. 740 LOOP
		...
		(enterdate, procesdate, completedate, user_id, service_id, provider_location_id, service_location_id, status, scenario, service_instance_id)
		values
		(e_date + 1/24 * a, pr_date + 1/24 * a, c_date + 1/24 * a, a, 4, 4, a, 'completed', 'New', null);
		insert into service_instances
		(user_id, service_order_id, status, service_id)
		values
		(a, a, 'active', 4);
  ...
  FOR a in 741 .. 800 LOOP
		...
		(enterdate, procesdate, completedate, user_id, service_id, provider_location_id, service_location_id, status, scenario, service_instance_id)
		values
		(e_date + 1/24 * a, pr_date + 1/24 * a, c_date + 1/24 * a, a, 5, 4, a, 'completed', 'New', null);
		insert into service_instances
		(user_id, service_order_id, status, service_id)
		values
		(a, a, 'active', 5);
  ...
  FOR a in 801 .. 870 LOOP
		...
		(enterdate, procesdate, completedate, user_id, service_id, provider_location_id, service_location_id, status, scenario, service_instance_id)
		values
		(e_date + 1/24 * a, pr_date + 1/24 * a, c_date + 1/24 * a, a, 1, 5, a, 'completed', 'New', null);
		insert into service_instances
		(user_id, service_order_id, status, service_id)
		values
		(a, a, 'active', 1);
  ...
  FOR a in 871 .. 940 LOOP
		...
		(enterdate, procesdate, completedate, user_id, service_id, provider_location_id, service_location_id, status, scenario, service_instance_id)
		values
		(e_date + 1/24 * a, pr_date + 1/24 * a, c_date + 1/24 * a, a, 2, 5, a, 'completed', 'New', null);
		insert into service_instances
		(user_id, service_order_id, status, service_id)
		values
		(a, a, 'active', 2);
  ...
  FOR a in 941 .. 1000 LOOP
		...
		values
		(e_date + 1/24 * a, pr_date + 1/24 * a, c_date + 1/24 * a, a, 5, 5, a, 'completed', 'New');
		insert into service_instances
		(user_id, service_order_id, status, service_id)
		values
		(a, a, 'active', 5);
