            ...
            <div class="row">
                <div class=" col-sm-6 col-sm-offset-3 paddingtop ">
                    <ul class="nav nav-tabs nav-justified">
                        ...
                        <li class=""><a href="#registration" data-toggle="tab" class="">Create new account</a></li>
                    </ul>
                        ...
                        <form class="form-horizontal" role="form" action="j_security_check" method="POST">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-6">
                                    <button type="submit" class="btn btn-primary nav-justified">Sign in</button>
                                </div>
                            </div>
                        </form>       
                    </div>
                    <div class="col-sm-12 tab-pane" id="registration">
                        ...
                        <form class="form-horizontal" role="form" action="Controller">
                            ...
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-3 control-label">Password (confirm)</label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-6">
                                    <button type="submit" name="command" value="validation" class="btn btn-primary nav-justified" id="register">Sign up</button>
                                </div>
                            </div>
                        </form>    
                    </div>
