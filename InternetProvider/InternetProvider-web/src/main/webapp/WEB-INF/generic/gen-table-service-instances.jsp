<%-- 
    Document   : gen-table-service-instances
    Created on : May 9, 2014, 2:29:51 PM
    Author     : Anatolii
--%>
...
<form role="form">
    <display:table name="sessionScope.service_instances" sort="external"  requestURI="Controller"
        ...
        <display:column property="id" title="ID" href="Controller?command=${param.command}" paramId="id" paramProperty="id"/>        
