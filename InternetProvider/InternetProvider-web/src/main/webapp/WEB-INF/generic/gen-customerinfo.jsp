...
<div id="customerinfo">
    <table class="table table-bordered table-striped">
        <tr>
            <td colspan="2">
                <h4>${customer.name}<button type="button" class="btn btn-default pull-right gobuttontop" id="password-changer-init2" data-toggle="tooltip" data-placement="left" title="Change password"><span class="glyphicon glyphicon-cog"></span> Modify</button></h4>
            </td>
        </tr>
        <tr>
            <td>
