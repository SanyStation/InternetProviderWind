        ...
        <div class="col-md-9 divitem">
            ...
            <form role="form">
                <display:table name="sessionScope.devices" export="true" requestURI="Controller"
                    ...
                    <display:setProperty name="export.rimpr.label" value="<button type=\"button\" class=\"btn btn-block btn-link\">XLS</button>"/>
                    <display:setProperty name="export.crimpr" value="true"/>
                    <display:setProperty name="export.crimpr.label" value="<button type=\"button\" class=\"btn btn-block btn-link\">CSV</button>"/>
