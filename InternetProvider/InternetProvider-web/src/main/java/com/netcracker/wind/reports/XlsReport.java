...
class XlsReport implements Report {
    ...
    /**
     * Generates name of destination file from name of template and current 
     * date and time.
     * 
     ...
     * XLSTransormer.
     * Method transformXLS(String templatePath, Map beans, String resultPath)
     * accepts the path to template file, map of beans (java beans that should
     * be exported to xls file) and result file path. In result will be 
     * generated the xls file with particular data.
     * 
